...
const AnonymousAuthProvider_1 = require("./auth/anonymous/AnonymousAuthProvider");
const NicknameAuthProvider_1 = require("./auth/nickname/NicknameAuthProvider");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!params.services) {
                ...
                if (params.authProviders) {
                    ...
                    authService.addProvider(new AnonymousAuthProvider_1.AnonymousAuthProvider());
                    authService.addProvider(new NicknameAuthProvider_1.NicknameAuthProvider());
                }
